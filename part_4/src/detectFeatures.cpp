...
int main(int argc,char** argv){
    ...
    cout<<"Key points of two images: "<<keypoint_1.size()<<", "<<keypoint_2.size()<<endl;
    ...
    drawKeypoints(img_1,keypoint_1,img_out1,Scalar::all(-1),DrawMatchesFlags::DEFAULT);
    ...
    //for(int i=0;i<good_matches.size();i++) printf("GoodMatch [%d] Point 1: %d -- Point 2: %d \n", i,good_matches[i].queryIdx,good_matches[i].trainIdx);
    ...
    cv::solvePnPRansac( pts_obj, pts_img, cameraMatrix, cv::Mat(), rvec, tvec, false, 100, 1.0, 0.99);
